...
public class ZoomServiceImpl extends UnicastRemoteObject implements ZoomService {
    ...
    public byte[] zoom(byte[] bmpBytes, String zoomType, int percent) throws RemoteException {
        System.out.println("C05 RMI zoom called: bytes=" + (bmpBytes == null ? 0 : bmpBytes.length)
        ...
        try {
            ...
            if (originalImage == null) {
                System.err.println("C05: Failed to read image");
                return bmpBytes;
            }
            ...
            System.out.println("C05: Resizing from " + originalWidth + "x" + originalHeight 
            ...
            System.out.println("C05: Zoom complete, result bytes=" + result.length);
            return result;

        } catch (Exception e) {
            System.err.println("C05: Error during zoom: " + e.getMessage());
            e.printStackTrace();
            return bmpBytes;
        }
    }
